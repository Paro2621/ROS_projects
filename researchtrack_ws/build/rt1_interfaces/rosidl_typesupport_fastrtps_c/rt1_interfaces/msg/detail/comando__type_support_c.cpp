...
#include "rt1_interfaces/msg/detail/comando__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rt1_interfaces
...
using _Comando__ros_msg_type = rt1_interfaces__msg__Comando;
...
size_t get_serialized_size_rt1_interfaces__msg__Comando(
  ...
  size_t current_alignment)
{
  const _Comando__ros_msg_type * ros_message = static_cast<const _Comando__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rt1_interfaces__msg__Comando;
    is_plain =
      (
...
static bool _Comando__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rt1_interfaces__msg__Comando * ros_message = static_cast<const rt1_interfaces__msg__Comando *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rt1_interfaces__msg__Comando(ros_message, cdr);
}

static bool _Comando__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  rt1_interfaces__msg__Comando * ros_message = static_cast<rt1_interfaces__msg__Comando *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rt1_interfaces__msg__Comando(cdr, ros_message);
}

static uint32_t _Comando__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rt1_interfaces__msg__Comando(
      untyped_ros_message, 0));
}

static size_t _Comando__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rt1_interfaces__msg__Comando(
...
static message_type_support_callbacks_t __callbacks_Comando = {
  "rt1_interfaces::msg",
  "Comando",
  _Comando__cdr_serialize,
  _Comando__cdr_deserialize,
  _Comando__get_serialized_size,
  _Comando__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _Comando__type_support = {
