...
bool rt1_interfaces__msg__comando__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rt1_interfaces.msg._comando.Comando", full_classname_dest, 35) == 0);
  }
  rt1_interfaces__msg__Comando * ros_message = _ros_message;
  {  // target
    ...
    ros_message->target = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // velocity
...
{
  /* NOTE(esteve): Call constructor of Comando */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rt1_interfaces.msg._comando");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Comando");
  ...
  {  // target
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->target);
    {
