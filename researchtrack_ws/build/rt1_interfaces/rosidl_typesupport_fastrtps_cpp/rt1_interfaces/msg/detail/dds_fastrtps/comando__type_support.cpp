...
#include "rt1_interfaces/msg/detail/comando__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rt1_interfaces::msg::Comando;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rt1_interfaces::msg::Comando *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rt1_interfaces::msg::Comando *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Comando__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rt1_interfaces::msg::Comando *>(
...
static size_t _Comando__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Comando(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Comando__callbacks = {
  "rt1_interfaces::msg",
  "Comando",
...
static rosidl_message_type_support_t _Comando__handle = {
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rt1_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<rt1_interfaces::msg::Comando>()
{
  return &rt1_interfaces::msg::typesupport_fastrtps_cpp::_Comando__handle;
}
