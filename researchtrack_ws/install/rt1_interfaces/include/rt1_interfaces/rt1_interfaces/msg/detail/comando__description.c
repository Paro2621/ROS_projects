  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe3, 0x36, 0x7f, 0xa6, 0x3c, 0xd0, 0xa5, 0x61,
      0x0a, 0xa1, 0x46, 0xc7, 0xf3, 0x4c, 0xf9, 0x58,
      0x65, 0x10, 0xbe, 0x56, 0x87, 0x70, 0x6f, 0xf2,
      0x0f, 0x2d, 0xb9, 0x78, 0xc5, 0xe0, 0xca, 0xd0,
    }};
  return &hash;
}
...
static char rt1_interfaces__msg__Comando__TYPE_NAME[] = "rt1_interfaces/msg/Comando";
static char geometry_msgs__msg__Twist__TYPE_NAME[] = "geometry_msgs/msg/Twist";
static char geometry_msgs__msg__Vector3__TYPE_NAME[] = "geometry_msgs/msg/Vector3";

// Define type names, field names, and default values
static char rt1_interfaces__msg__Comando__FIELD_NAME__target[] = "target";
static char rt1_interfaces__msg__Comando__FIELD_NAME__velocity[] = "velocity";

static rosidl_runtime_c__type_description__Field rt1_interfaces__msg__Comando__FIELDS[] = {
  {
    {rt1_interfaces__msg__Comando__FIELD_NAME__target, 6, 6},
    {
  ...
  {
    {rt1_interfaces__msg__Comando__FIELD_NAME__velocity, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rt1_interfaces__msg__Comando__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {geometry_msgs__msg__Twist__TYPE_NAME, 23, 23},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rt1_interfaces__msg__Comando__TYPE_NAME, 26, 26},
      {rt1_interfaces__msg__Comando__FIELDS, 2, 2},
    },
    {rt1_interfaces__msg__Comando__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rt1_interfaces__msg__Comando__get_individual_type_description_source(NULL),
